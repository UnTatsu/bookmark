...
<body>
                ...
                <fieldset>
                    ...
                    <table id="ftable">
                        <tr>
                            ...
                            <td><input type="text" name="bookimg" id="bookimg"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="bookurl" id="bookurl" required placeholder="入力必須"></td>
                        </tr>
                        <tr>
    ...
    <script>
        ...
        //お気に入り一覧に移管
        $("#navbar-header2").on('click', function(){
            window.open('select2.php')
        })
